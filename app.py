...
<style>
  ...
  .site-title {
    color: #c084fc; font-size: 1.05rem; font-weight: 700;
    letter-spacing: 0.18em; text-transform: uppercase; margin: 0;
  }
  .site-subtitle { color: #64748b; font-size: 0.85rem; margin: 0.25rem 0 1.1rem 0; }
  ...
  .kpi-value { font-size: 2rem; font-weight: 700; color: #c084fc; margin: 0; line-height: 1; }
  .kpi-label { font-size: 0.73rem; color: #64748b; margin-top: 0.3rem;
  ...
  /* Section headings */
  .section-title { font-size: 1.35rem; font-weight: 600; color: #e2e8f0; margin-bottom: 0.3rem; }
